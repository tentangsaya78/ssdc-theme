...
if ($rule->have_posts()) :  ?>
    <div class="container py-20">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            ?>
                <a href="<?php echo esc_url($rule_link); ?>" class="rule-item relative  bg-white rounded-lg border border-gray-300  h-full max-h-[480px] overflow-hidden group">
                    ...
                    <div class="rule-item__content p-4 absolute  bottom-0 z-20 text-2xl lg:text-4xl text-white">
