    ...
    <section class="bg-primary text-white pt-20 pb-3 border-t-2 border-white/20">
        <div class="container-full">
            <div class="flex flex-wrap justify-between gap-6 lg:gap-12 mb-20">
                ...
                <div>
                    <h4 class="lg:text-5xl">Contact Info</h4>
                    <ul>
                        <li>
                            <button
                        ...
                        <li>
                            <a href="<?php echo $instagram['url']; ?>" class="lg:text-3xl flex items-center gap-3 hover:text-accent duration-200 group:">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 justify-center items-center">
                <p class="text-sm lg:text-xl">Copyright All Rights Reserved</p>
                <a href="#" class="text-sm lg:text-xl lg:text-center"> Back to Top <i class="bi bi-arrow-up"></i></a>
                <div></div>
            </div>
